...
export default function App() {
  ...
  return (
    <div className="min-h-dvh w-full max-w-full flex flex-col">
      {/* Status indicator */}
      <div className="fixed top-4 right-4 z-50 max-w-[calc(100vw-2rem)]">
        <div className="flex items-center gap-2 px-3 py-1.5 bg-surface-light/80 backdrop-blur-sm rounded-full border border-surface-lighter/40 text-xs">
          ...
          />
          <span className="text-text-muted truncate" data-testid="server-status">
      ...
      {/* Main content */}
      <main className="flex-1 flex flex-col items-center justify-center w-full max-w-full min-w-0 px-4 py-16 sm:py-20">
        {/* Hero */}
        <div className="text-center mb-10 sm:mb-12 space-y-3 sm:space-y-4 w-full max-w-2xl px-1">
          ...
          <p className="text-text-muted text-base sm:text-lg max-w-md mx-auto px-2">
        ...
        {/* Supported platforms */}
        <div className="mt-12 sm:mt-16 flex flex-wrap justify-center gap-4 sm:gap-6 text-text-muted/50 text-sm w-full max-w-2xl px-2">
      ...
      {/* Footer */}
      <footer className="py-6 px-4 text-center text-text-muted/40 text-xs w-full">
